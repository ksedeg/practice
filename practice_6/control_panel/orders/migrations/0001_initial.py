...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'orders_order', (
            ...
            ('created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 5, 0, 0))),
        ))
    ...
    models = {
        ...
        u'library.book': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publication_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 5, 0, 0)'}),
        ...
        u'orders.order': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
